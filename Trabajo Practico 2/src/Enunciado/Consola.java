...
{
    /**
     * Lee desde el teclado de consola un caracter simple y lo retorna. Si ocurre alg�n problema mientras se efect�a 
     * la lectura, el m�todo retornar� un caracter de espacio en blanco.
    ...
    */
     ...
     * al presionar <Enter>). Si la secuencia inctroducida por teclado NO ES un n�mero entero, el m�todo ignorar� 
     * la carga y emitir� un mensaje solicitando una nueva carga.
     ...
     * al presionar <Enter>). Si la secuencia inctroducida por teclado NO ES un n�mero double v�lido, el m�todo ignorar� 
     * la carga y emitir� un mensaje solicitando una nueva carga.
